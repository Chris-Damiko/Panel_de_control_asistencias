...
// Carpeta local -> carpeta en el repo de datos.
const FOLDERS = [
  { local: 'data', remote: 'data', ext: '.json' },
  { local: 'public/uploads/logos', remote: 'uploads/logos' },
  { local: 'public/uploads/favicons', remote: 'uploads/favicons' },
  { local: 'public/uploads/empleados', remote: 'uploads/empleados' },
];
...
async function push(absPath, remotePath) {
  ...
  for (let attempt = 0; attempt < 3; attempt++) {
    const body = {
      message: `data: actualizar ${remotePath}`,
